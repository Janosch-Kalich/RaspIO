...
export class NewPinComponent implements OnInit {
  ...
  constructor(private http: HttpClient, private storage: Storage, private router: Router, private alertcontroller: AlertController, private requests: RequestsService) { }
